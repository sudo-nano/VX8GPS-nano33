/* This code modified from https://github.com/WaterstarRunner/VX8GPS-Xiao 
by sudo-nano on Github to work with the Arduino Nano 33 IoT

Modifications: 
- Added software serial port mySerial for receiving from GPS
- Now using mySerial to receive GPS strings
*/
#include <Arduino.h>
...
char rxChar;  //the actual char read from mySerial
